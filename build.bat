...
mkdir bin
mkdir bin\Scripts\
copy Mizu\bin\Release\Mizu.exe bin\Mizu.exe
copy Mizu\bin\Release\Mizu.Lib.Evaluator.dll bin\Mizu.Lib.Evaluator.dll
copy Mizu\bin\Release\Mizu.Parser.dll bin\Mizu.Parser.dll
