...
namespace Mizu.Parser
{
    ...
    public partial class Parser 
    {
        ...
        private void ParseStart(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.QUESTION, TokenType.IDENTIFIER, TokenType.PERIOD, TokenType.ABS, TokenType.SIN, TokenType.TAN);
        ...
        private void ParseStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.EOF, TokenType.STATEMENTSEP);
            switch (tok.Type)
            {
                case TokenType.EOF:
        ...
        private void ParseVarStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.NUMBER, TokenType.OPENBR);
            switch (tok.Type)
            {
        ...
        private void ParsePrintStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.IDENTIFIER, TokenType.SET);
            switch (tok.Type)
            {
                case TokenType.IDENTIFIER:
                ...
                case TokenType.SET:
                    ...
                    tok = scanner.LookAhead(TokenType.NUMBER, TokenType.IDENTIFIER, TokenType.BROPEN, TokenType.ABS, TokenType.SIN, TokenType.TAN);
                    switch (tok.Type)
                    {
                        case TokenType.NUMBER:
                        case TokenType.IDENTIFIER:
        ...
        private void ParseMathCMDStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.ABS, TokenType.SIN, TokenType.TAN);
            switch (tok.Type)
            {
                case TokenType.ABS:
