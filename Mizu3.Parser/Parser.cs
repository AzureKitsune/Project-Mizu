...
namespace Mizu3.Parser
{
    ...
    public partial class Parser 
    {
        ...
        private void ParseVariableReassignmentStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.LT, TokenType.OPENBR);
            ...
            tok = scanner.LookAhead(TokenType.EQUAL, TokenType.ARROW);
            switch (tok.Type)
            {
                case TokenType.EQUAL:
                    ...
                    tok = scanner.LookAhead(TokenType.BROPEN, TokenType.PLUS, TokenType.MINUS, TokenType.MULTI, TokenType.DIV, TokenType.STRING, TokenType.NUMBER, TokenType.TRUE, TokenType.FALSE, TokenType.FLOAT, TokenType.IDENTIFIER, TokenType.FUNC);
                    switch (tok.Type)
                    {
        ...
        private void ParseLetStatement(ParseNode parent)
        {
            ...
            switch (tok.Type)
            {
                case TokenType.EQUAL:
                    ...
                    tok = scanner.LookAhead(TokenType.STRING, TokenType.NUMBER, TokenType.TRUE, TokenType.FALSE, TokenType.FLOAT, TokenType.IDENTIFIER, TokenType.ITER, TokenType.FUNC, TokenType.NEW, TokenType.LT, TokenType.OPENBR, TokenType.BROPEN, TokenType.PLUS, TokenType.MINUS, TokenType.MULTI, TokenType.DIV);
                    switch (tok.Type)
                    {
                        case TokenType.STRING:
                        case TokenType.NUMBER:
        ...
        private void ParseOutStatement(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.STRING, TokenType.NUMBER, TokenType.TRUE, TokenType.FALSE, TokenType.FLOAT, TokenType.IDENTIFIER, TokenType.RETURN);
            if (tok.Type == TokenType.STRING
                || tok.Type == TokenType.NUMBER
                || tok.Type == TokenType.TRUE
                || tok.Type == TokenType.FALSE
        ...
        private void ParseMethodCallStatement(ParseNode parent)
        {
            Token tok;
            ParseNode n;
            ParseNode node = parent.CreateNode(scanner.GetToken(TokenType.MethodCallStatement), "MethodCallStatement");
            parent.Nodes.Add(node);
        ...
        private void ParseNonArrayArgument(ParseNode parent)
        {
            Token tok;
            ParseNode n;
            ParseNode node = parent.CreateNode(scanner.GetToken(TokenType.NonArrayArgument), "NonArrayArgument");
            parent.Nodes.Add(node);
        ...
        private void ParseMethodCall(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.BROPEN, TokenType.EQUAL, TokenType.ARROW);
            if (tok.Type == TokenType.BROPEN
                || tok.Type == TokenType.EQUAL
        ...
        private void ParseArrayIndexExpr(ParseNode parent)
        {
            ...
            tok = scanner.LookAhead(TokenType.LT);
            if (tok.Type == TokenType.LT)
            {
                ParseGenericTypeIdentifier(node);
            }
        ...
        private void ParseGenericTypeIdentifier(ParseNode parent)
        {
            Token tok;
            ParseNode n;
            ParseNode node = parent.CreateNode(scanner.GetToken(TokenType.GenericTypeIdentifier), "GenericTypeIdentifier");
            parent.Nodes.Add(node);
